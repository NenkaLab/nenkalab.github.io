    ...
    class LinkPreview {
        ...
        createChip(linkData, index) {
            ...
            chip.innerHTML = `
                ...
                <svg class="w-3 h-3 text-zinc-500 dark:text-zinc-400 shrink-0 transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-blue-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
